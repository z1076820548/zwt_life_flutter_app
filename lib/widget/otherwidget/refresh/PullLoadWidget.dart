...
class _PullLoadWidgetState extends State<PullLoadWidget> {
  ...
  Widget build(BuildContext context) {
    return new RefreshIndicator(
      ///GlobalKey，用户外部bottomWidget获取RefreshIndicator的State，做显示刷新
      key: refreshKey,
    ...
    return new Container(
      ...
      child: new Column(
        ...
        children: <Widget>[
          FlatButton(
            onPressed: () {},
            child: new Image(image: new AssetImage(GlobalIcons.DEFAULT_USER_ICON), width: 70.0, height: 70.0),
          ),
          Container(
  ...
  Widget _buildProgressIndicator() {
    ...
    Widget bottomWidget = (control.needLoadMore)
      ...
      ///loading框
      new SpinKitThreeBounce(color: Theme.of(context).primaryColor),
      new Container(
        width: 5.0,
      ),
